...
> **Warning**: Though the DSVM uses IE as the default browser, we do not recommend it for LUIS. As it only takes a few minutes, we recommend downloading either [Microsoft Edge](https://www.microsoft.com/en-us/download/details.aspx?id=48126) or [Google Chrome](https://www.google.com/intl/en/chrome/) and using that as your main browser for the remainder of the labs.
